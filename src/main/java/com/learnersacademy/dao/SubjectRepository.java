...
public interface SubjectRepository extends JpaRepository<Subject, Long> {
		...
		@Query(nativeQuery = true, value = "SELECT t.last_name AS lastName, t.first_name AS firstName, c.course_id AS courseId, c.course_name AS courseName FROM teachers AS t "
